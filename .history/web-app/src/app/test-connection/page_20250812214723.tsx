  ...
  const testConnection = async () => {
    ...
    try {
      ...
      if (healthResponse.ok) {
        ...
        addLog('✅ Backend health check successful');
      } else {
    ...
    try {
      ...
      if (authResponse.ok) {
        ...
        addLog(`✅ API working - Books found: ${authData.data?.length || 0}`);
      } else {
    ...
    try {
      ...
      if (loginResponse.ok) {
        ...
        addLog(`✅ Admin login successful - Role: ${loginData.user?.role || 'admin'}`);
      } else {
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className={`p-6 rounded-lg border-2 ${getStatusColor(status.backend)}`}>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-1">خادم API</h3>
                <p className="text-sm">Vercel Serverless</p>
              </div>
            </div>
            ...
            <div className={`p-6 rounded-lg border-2 ${getStatusColor(status.auth)}`}>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-1">نظام البيانات</h3>
                <p className="text-sm">Books API</p>
              </div>
            </div>
