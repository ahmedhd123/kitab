...
// @desc    Get sample books for frontend compatibility
// @access  Public
router.get('/sample', bookController.getAllBooks);

// @route   GET /api/books/sample/:id
// @desc    Get single book from sample endpoint for frontend compatibility
// @access  Public
router.get('/sample/:id', bookController.getBookById);
...
const debugMiddleware = (req, res, next) => {
  console.log('🔧 Book POST route - before upload middleware');
...
// @access  Private
router.post('/', auth, debugMiddleware, uploadMultiple, (req, res, next) => {
    console.log('📁 Files after upload:', req.files);
    console.log('📝 Body after upload:', req.body);
    next();
}, bookController.createBook);

// Error handling for upload must be defined separately
