    ...
    this.sampleBooks = [
      {
        ...
        description: 'رواية عربية معاصرة تحكي قصة حب وحنين',
        genre: 'الأدب العربي',
        language: 'arabic',
        publishYear: 2010,
        pages: 320,
        publisher: 'دار الآداب',
        tags: ['رواية', 'أدب', 'معاصر'],
        status: 'published',
        isFree: true,
        price: 0,
        rating: 4.5,
      ...
      },
      {
        ...
        description: 'رواية الواقعية السحرية الشهيرة',
        genre: 'الأدب العالمي',
        language: 'arabic',
        publishYear: 1967,
        pages: 448,
        publisher: 'دار المدى',
        tags: ['رواية', 'واقعية سحرية', 'مترجم'],
        status: 'published',
        isFree: false,
        price: 45.50,
        rating: 4.8,
        ...
        updatedAt: '2023-02-10T10:30:00.000Z'
      },
      {
        _id: 'sample_3',
        title: 'تاريخ الطبري',
        author: 'محمد بن جرير الطبري',
        description: 'تاريخ الرسل والملوك - مرجع تاريخي مهم',
        genre: 'التاريخ',
        language: 'arabic',
        publishYear: 915,
        pages: 2800,
        publisher: 'دار المعارف',
        tags: ['تاريخ', 'تراث', 'مرجع'],
        status: 'published',
        isFree: true,
        price: 0,
        rating: 4.3,
        ...
        updatedAt: '2023-03-05T14:20:00.000Z'
      }
    ];
