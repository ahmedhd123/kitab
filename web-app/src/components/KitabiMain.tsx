...
import { getLocalBooksStats } from '@/lib/localBooks';
...
export default function KitabiMain() {
  ...
  // الحصول على إحصائيات الكتب المحلية
  const localStats = getLocalBooksStats();

  const stats = {
    totalBooks: 15420 + localStats.totalBooks,
    totalReads: 89320,
    totalUsers: 5240,
    newBooks: 142 + localStats.totalBooks,
    localBooks: localStats.totalBooks
  };
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-white rounded-lg p-6 text-center shadow-sm">
                ...
                {stats.localBooks > 0 && (
                  <p className="text-xs text-purple-600 mt-1">+{stats.localBooks} محلي</p>
                )}
              </div>
